  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.user.role === 'user') {
        navigate('/user/dashboard'); // Success! Go to user dashboard
      } else {
        // Security check: An admin tried to use the user login page
      ...
      <div className="mx-auto grid items-stretch min-h-[680px] max-w-7xl gap-0 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        >
          <div className="flex items-center gap-3 mb-10">
            <div className="flex h-14 w-14 items-center justify-center rounded-3xl bg-purple-500/10 border border-purple-500/20 text-purple-400">
              <Shield size={24} />
            </div>
            <div>
              <p className="text-sm uppercase tracking-[0.35em] text-purple-300">AI SMART</p>
              <p className="text-xs uppercase tracking-[0.35em] text-gray-500">SURVEILLANCE SYSTEM</p>
            </div>
          </div>

          <div className="mb-10">
            <h1 className="text-4xl font-bold text-white">User Login</h1>
            <p className="mt-3 text-gray-400">Sign in to access your monitoring dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="relative block">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-3xl border border-white/10 bg-[#06111f] px-14 py-4 text-white placeholder:text-gray-500 outline-none transition focus:border-purple-400 focus:ring-1 focus:ring-purple-400/20"
                />
              </label>
            </div>
            ...
            <div>
              <label className="relative block">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-3xl border border-white/10 bg-[#06111f] px-14 py-4 pr-16 text-white placeholder:text-gray-500 outline-none transition focus:border-purple-400 focus:ring-1 focus:ring-purple-400/20"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between gap-4 text-sm text-gray-300">
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  className="h-4 w-4 rounded border-gray-600 bg-[#06111f] text-purple-400 focus:ring-purple-400/20"
                />
                Remember me
              </label>
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full rounded-3xl bg-purple-500 px-6 py-4 text-base font-semibold text-white shadow-[0_20px_40px_rgba(168,85,247,0.25)] transition hover:bg-purple-400 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            >
              <span className="inline-flex items-center justify-center gap-2">
                ...
                Login with OTP
                    ...
                    {/* ... existing Login with OTP button ... */}
        ...
        >
          ...
          <div className="relative z-10 flex h-full flex-col justify-between p-8 sm:p-12">
            <div className="rounded-[2rem] border border-purple-500/10 bg-[#061426]/55 p-6 backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.25)]">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-3xl bg-purple-500/20 text-purple-400">
                  <Camera size={22} />
                </div>
                <div>
                  <p className="text-sm uppercase tracking-[0.35em] text-purple-300">AI SMART</p>
